...
export default function ContractCreate({ contacts }: Props) {
    const [form, setForm] = useState({
        ...
        end_date:            '',
        auto_renew:          false,
        renewal_notice_days: 30 as number | '',
        description:         '',
        terms:               '',
    });
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        setProcessing(true);
        router.post('/finance/contracts', form, {
            ...
            <div className="mx-auto max-w-3xl space-y-6">
                ...
                <form onSubmit={handleSubmit} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setForm({ ...form, renewal_notice_days: e.target.value ? Number(e.target.value) : '' })}
                    ...
                    <div className="flex justify-end gap-3 pt-4">
                        <a href="/finance/contracts" className="rounded-md border border-slate-300 px-4 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
                            Cancel
                        </a>
