...
import type { Contact, RecurringFrequency } from '@/types/finance';
...
export default function RecurringInvoiceCreate({ contacts }: Props) {
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        setProcessing(true);
        router.post('/finance/recurring-invoices', {
            ...form,
    ...
    return (
        <AppLayout>
            ...
            <div className="mx-auto max-w-4xl space-y-6">
                <h1 className="text-2xl font-semibold text-slate-900">New Recurring Invoice</h1>
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Frequency <span className="text-red-500">*</span></label>
                            ...
                            <div>
                                <label className="block text-sm font-medium text-slate-700 mb-1">Due Days <span className="text-red-500">*</span></label>
                                <input type="number" min="0" max="365" value={form.due_days}
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <Button type="submit" disabled={processing}>Create Recurring Invoice</Button>
                    </div>
                </form>
            </div>
        </AppLayout>
