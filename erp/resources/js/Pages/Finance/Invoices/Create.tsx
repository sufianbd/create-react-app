...
export default function InvoiceCreate({ contacts, currencies = ['USD', 'EUR', 'GBP', 'JPY', 'CAD', 'AUD', 'CHF', 'CNY', 'INR', 'SGD'] }: Props) {
                    ...
                    <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
                        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
                            <div className="sm:col-span-2">
                                <label className="block text-sm font-medium text-slate-700 mb-1">Contact (Billable To)</label>
