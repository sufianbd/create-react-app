...
import type { Department, Employee, EmploymentType, SalaryType } from '@/types/hr';
...
export default function EmployeeEdit({ employee, departments, users }: Props) {
    const [form, setForm] = useState({
        ...
        user_id:         employee.user_id ?? ('' as number | ''),
    ...
    function submit(e: React.FormEvent) {
        e.preventDefault();
        setProcessing(true);
        router.put(`/hr/employees/${employee.id}`, {
            ...form,
                ...
                <form onSubmit={submit} className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="number" min="0" step="0.01" value={form.salary_amount}
