...
export default function WorkflowCreate({ users, roles }: Props) {
    const { data, setData, post, processing, errors } = useForm<{
        ...
        max_amount: '',
        is_active: true,
        steps: [{ name: '', approver_id: '', approver_role: '', is_required: true }],
    });
    ...
    function updateStep(index: number, field: keyof Step, value: string | boolean) {
            ...
            <div className="mx-auto max-w-3xl space-y-6">
                ...
                <form onSubmit={submit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="0.00"
                                />
                                {errors.min_amount && <p className="mt-1 text-xs text-red-600">{errors.min_amount}</p>}
                            </div>
                            <div>
                                ...
                                />
                                {errors.max_amount && <p className="mt-1 text-xs text-red-600">{errors.max_amount}</p>}
                            </div>
                        </div>
                    ...
                    <div className="flex justify-end gap-3">
                        <Link href="/approvals/workflows"><Button type="button" variant="secondary">Cancel</Button></Link>
                        <Button type="submit" disabled={processing}>Create Workflow</Button>
                    </div>
                </form>
            </div>
        </AppLayout>
