...
export default function PutAwayRuleCreate({ warehouses, products, categories, zones, bins }: Props) {
    ...
    function handleSubmit(e: React.FormEvent) {
        e.preventDefault();
        post('/inventory/put-away-rules');
    }

    return (
        <AppLayout>
            <Head title="New Put-Away Rule" />
            <div className="space-y-6">
                <div>
                    <h1 className="text-2xl font-semibold text-slate-900">New Put-Away Rule</h1>
                </div>
