...
class EmployeePolicy
{
    ...
    public function update(User $user, ?Employee $employee = null): bool { return $user->can('hr.update'); }
    public function delete(User $user, ?Employee $employee = null): bool { return $user->can('hr.delete'); }
}
